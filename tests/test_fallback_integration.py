...
def test_fallback_to_edge_tts_when_interpreter_resolution_raises(monkeypatch):
    ...
    **Validates: Requirements 2.2, 2.9**
    ...
    # edge_tts was invoked exactly once with the same utterance (Req 2.2).
    # Expression tags (<laugh>/<sigh>) kini dikonversi ke vokalisasi SEBELUM
    # engine dipilih, jadi edge_tts menerima teks hasil strip yang sama.
    assert result["edge_calls"] == [bridge.strip_tts_expression_tags(text)]
