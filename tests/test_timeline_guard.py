...
def test_find_earliest_viewer_mention(tmp_path):
    ...
    (sessions / "2026-05-27-default.md").write_text("Viewer penontonpertama hello", encoding="utf-8")
    (sessions / "2026-06-05-default.md").write_text("penontonpertama lagi chat", encoding="utf-8")
    assert tg.find_earliest_viewer_mention("penontonpertama", tmp_path) == "2026-05-27"
...
def test_memory_quality_skip_patterns():
    ...
    assert mq.should_save_learning("Bohan suka kopi hitam")
