...
def vision_chat(
    ...
    *,
    ...
    # Param khusus provider — mis. `reasoning_effort: "none"` untuk qwen3.6, yang tanpa
    # itu menghabiskan max_tokens (256 di jalur vision) untuk chain-of-thought dan
    # mengembalikan content kosong. Pola bug yang sama dengan fix dd88d9e.
    if extra_payload:
